                    ...
                    <div class="well">
                        ...
                        <form enctype="multipart/form-data" action={{route('login')}} method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="correo" value="" placeholder="Correo electronico" id="correo" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="input-password">Contraseña</label>
                                <input type="password" name="password" value="" placeholder="Contraseña" id="password" class="form-control">
                                <div class="text-right"><a href="/iniciar_sesion">Olvide contraseña</a></div>
                            </div>
