...
<div id="product-product" class="container">
 <ul class="breadcrumb">
        ...
        <li><a href="/tienda">vegetables</a></li>
        <li><a href="/info_producto"> Banana - 1 kg </a></li>
      </ul>
  <div class="row">
    ...
    <div id="content" class="col-xs-12">
      ...
      <div class="row">
                                ...
                                <ul class="thumbnails">
                                                        <li><a class="thumbnail" href="/image/cache/catalog/product/14-700x800.jpg">
                                    <div style="height:519px;width:455px;" class="zoomWrapper"><img data-zoom-image="/image/cache/catalog/product/14-700x800.jpg" src="/image/cache/catalog/product/14-545x621.jpg" id="zoom_03" class="img-responsive center-block" alt="image" style="position: absolute;"></div>
                                </a>
                            </li>
                                                                                    <div class="row">
                            <li id="gallery_01" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                                                                <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 944px; left: 0px; display: block; transition: all 1000ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 118px;"><a data-zoom-image="/image/cache/catalog/product/27-700x800.jpg" data-image="/image/cache/catalog/product/27-700x800.jpg" href="/image/cache/catalog/product/27-700x800.jpg" class="col-xs-12">
                                    <img src="/image/cache/catalog/product/27-114x130.jpg" class="img-responsive center-block" alt="additional image">
                                </a></div><div class="owl-item" style="width: 118px;"><a data-zoom-image="/image/cache/catalog/product/16-700x800.jpg" data-image="/image/cache/catalog/product/16-700x800.jpg" href="/image/cache/catalog/product/16-700x800.jpg" class="col-xs-12">
                                    <img src="/image/cache/catalog/product/16-114x130.jpg" class="img-responsive center-block" alt="additional image">
                                </a></div><div class="owl-item" style="width: 118px;"><a data-zoom-image="/image/cache/catalog/product/18-700x800.jpg" data-image="/image/cache/catalog/product/18-700x800.jpg" href="/image/cache/catalog/product/18-700x800.jpg" class="col-xs-12">
          ...
          <h1> Banana - 1 kg </h1><hr class="producthr">
          <ul class="list-unstyled">
                        <li><span class="text-decor">Brand:</span><a href="https://madebyhand.in/opencart/FS03/Fashion01/index.php?route=product/manufacturer/info&amp;manufacturer_id=7" class="textdeb">Hewlett-Packard</a></li>
                        <li><span class="text-decor">Product Code:</span> Product 21</li>
                        <li><span class="text-decor">Reward Points:</span> 300</li>
            ...
            <div class="row">
             ...
             <button type="button" data-toggle="tooltip" title="" class="btn pcrt btn-primary" onclick="wishlist.add('47');" data-original-title="Add to Wish List"><svg width="18px" height="17px"><use xlink:href="#heart"></use></svg></button>
              <button type="button" data-toggle="tooltip" title="" class="btn pcrt  btn-primary" onclick="compare.add('47');" data-original-title="Compare this Product"><svg width="18px" height="17px"><use xlink:href="#compare"></use></svg></button>
              <hr class="producthr">
            </div>
            <!-- Quantity option end -->
            </div>
